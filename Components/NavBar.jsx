...
export default () => {
   ...
   return ( <>
      <nav className={`bg-black pb-2 md:text-sm ${
                ...
                ? "block" : "hidden"} `}>
                  ...
                  <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 
                      ...
                      {currentUser ? (
                        ...
                        className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-white-800 hover:bg-gray-700 active:bg-white-900 rounded-full md:inline-flex"
                      >
                        ConnectWallet 
                        <Nav3 />
                      </button>
